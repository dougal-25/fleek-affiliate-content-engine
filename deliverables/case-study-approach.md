...
- **P0 — The deck**: **14 slides**, vanilla HTML at `deck/`, ~~built in Canva~~. NOT 25–30: twenty minutes is ~90 seconds a slide; 25+ means rushing your best material. Dark to present, light to send — `index.html` is the reviewer copy, `index.html?notes` the presenter copy. *(Medium reversed 2026-07-09 16:32; see `spec/decisions/2026-07-10-evidence-and-deck.md`.)*
...
- **P0 — The receipts**: `evidence/` — 17 curated exchanges, verbatim from the raw Claude Code transcripts, generated by `scripts/extract_receipts.py`. This is the brief's *"actual prompts including the failures"*, and it is not optional.
...
Deck + database + demo + receipts tell the whole story. Receipts live **in** the slides as a recurring pushback
strip; `evidence/` is the archive behind them. There is no separate Notion appendix — the evidence pages are it.
...
| Deck | Vanilla HTML/CSS/JS, in the repo | Versioned beside the engine, real clickable links, no build step, exports the reviewer PDF directly. *(Was Canva; reversed 2026-07-09 16:32.)* |
...
- **Day 4:** HTML deck build · demo rehearsal · record in-deck demo clips (Kalodata, agent run, terminal) · evidence pages
...
1. ~~Deck tool~~ → ~~DECIDED: Canva~~ → **REVERSED 2026-07-09 16:32: vanilla HTML in the repo.** Versioned beside the engine, real links, exports the reviewer PDF directly. See `spec/decisions/2026-07-10-evidence-and-deck.md`.
