...
Part of [[FLEEK BRAIN Index]] · siblings: [[Vintage Reseller Creator Ecosystem]], [[FR Creator Content Formats]], [[French Reseller Community Sentiment]]
...
| Creator | Platform | Niche / note | Followers |
|---|---|---|---|
| **Hannah Stioui — "Na Nin Vintage"** | IG | Founded 2016, seconde-main pieces, sells **exclusively on Vinted** (e-shop coming) | ~14k [3] |
| **@emmaverdierkremer** | IG | Ex-comms freelance, <1yr in seconde-main, chine en France, "dress more responsibly" angle | <50k [1] |
| **Nawal Bonnefoy** | IG | Self-described "serial chineuse", beginner-friendly vintage shopping | micro [3] |
| **Zoé Léger — "Zoélegervintage"** | IG | Model; builds looks around vintage finds, sells via DM | micro [3] |
| **Very frip (Morgane & Jeanne) — @veryfrip** | IG/YT | Two Lyon friperie entrepreneurs | micro [2] |
| **Alichuree** | IG | DIY/deco hybrid seconde-main + neuf; ~30% of looks chinés (Vestiaire, Vinted, dépôts-vente) | ~93k [4] |

*All follower counts are as-reported by the cited press pieces (2022–2026) — re-verify live before scoring.*

### Rising TikTok creators (⚠️ thin lane — but the scrape already covers it)
Search returned **no** verified rising *friperie-specific* TikTok handles for 2026. General FR fashion influencers surfaced (`eligs_`, `julymoreiraparis`, `chrristinne`, `naaarciss` — [Heepsy](https://www.heepsy.com/top-tiktok/fashion/france)) but they are **lifestyle, not resale**. This is expected — TikTok reseller-creators are found empirically, not via Perplexity. **The discovery engine has already run** (`scripts/run_discovery.py`, 2026-07-09 evening): 12 real FR reseller creators scraped, scored, and upserted to Airtable — *that* is the live TikTok seed list; this page is the press-sourced (mostly-IG) complement. See the discovery milestone in [[FLEEK BRAIN Log]].
...
- **TikTok** rising-creator handles — the biggest remaining hole; discovery scrape is the fix.
- Whether any name above already sources at wholesale (→ warm outreach: they're already buyers).

Feeds: **discovery** (seed handles + hashtag validation), **scoring** (starter shortlist to rank), **outreach** (named, warm-startable targets).

### Sources
- https://www.cosmopolitan.fr/ces-comptes-a-suivre-pour-acheter-du-vintage,2027843.asp — Na Nin Vintage, Nawal Bonnefoy, Zoé Léger
- https://www.lefigaro.fr/medias/de-shein-a-la-friperie-quand-les-influenceurs-mode-tentent-de-se-mettre-au-vert-20221230 — @emmaverdierkremer
- https://www.cm-cm.fr/post/etonnante-transition-seconde-main-neuf-decryptage-point-bascule-influence — Alichuree
- https://www.youtube.com/watch?v=khFj3ftZmig — Very frip (Lyon)
- https://www.heepsy.com/top-tiktok/fashion/france — general FR fashion influencer list (non-resale)
- Full raw answers: `_raw/perplexity_fr_deepdive_2026-07-09.jsonl` (Q6, Q7, Q8, Q9)
